        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    ?>
                    <div class="box">
                        <form action="../function/cadastrar_usuario.php" method="GET">
                            <div class="field">
                                <div class="control">
                                    <input name="nome" type="text" class="input is-large" placeholder="Nome" required autofocus autocomplete="off">
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
