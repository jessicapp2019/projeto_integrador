                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (($nivel == 1) || ($nivel == 2)) { ?>
                                <a class="btn-editar btn btn-sm btn-primary" href="editar_produto.php?id=<?= $idProduto ?>" role="button"><i class="far fa-edit"></i> Editar</a>
                            <?php } ?>
                            <?php if ($nivel == 1) { ?>
                                <a class="btn-editar btn btn-sm btn-danger" href="excluir_produto.php?id=<?= $idProduto ?>" role="button"><i class="far fa-trash-alt"></i> Excluir</a></td>
                    <?php } ?>
                    </tr>
                <?php } ?>
